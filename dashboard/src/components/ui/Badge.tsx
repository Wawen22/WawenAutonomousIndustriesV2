...
const VARIANT_STYLES: Record<string, string> = {
  ...
  skill:       'bg-cyan-500/10   text-cyan-300   ring-1 ring-cyan-500/25',
  plugin:      'bg-indigo-500/10 text-indigo-300 ring-1 ring-indigo-500/25',
  integration: 'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  memory_provider: 'bg-amber-500/10 text-amber-300 ring-1 ring-amber-500/25',
  channel:     'bg-fuchsia-500/10 text-fuchsia-300 ring-1 ring-fuchsia-500/25',
  active:      'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  beta:        'bg-sky-500/10    text-sky-300    ring-1 ring-sky-500/25',
  planned:     'bg-amber-500/10  text-amber-300  ring-1 ring-amber-500/25',
  disabled:    'bg-slate-500/10  text-slate-300  ring-1 ring-slate-500/25',
  connected:   'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  degraded:    'bg-amber-500/10  text-amber-300  ring-1 ring-amber-500/25',
  missing_config: 'bg-orange-500/10 text-orange-300 ring-1 ring-orange-500/25',
  auth_required: 'bg-yellow-500/10 text-yellow-300 ring-1 ring-yellow-500/25',
  failing:     'bg-rose-500/10   text-rose-300   ring-1 ring-rose-500/25',
  personal:    'bg-[#7CF6E6]/10  text-[#7CF6E6]  ring-1 ring-[#7CF6E6]/25',
  company:     'bg-[#00D4FF]/10  text-[#00D4FF]  ring-1 ring-[#00D4FF]/25',
  shared:      'bg-violet-500/10 text-violet-300 ring-1 ring-violet-500/25',
  low:         'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  medium:      'bg-amber-500/10  text-amber-300  ring-1 ring-amber-500/25',
  high:        'bg-rose-500/10   text-rose-300   ring-1 ring-rose-500/25',
  open:        'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  restricted:  'bg-sky-500/10    text-sky-300    ring-1 ring-sky-500/25',
  approval_required: 'bg-orange-500/10 text-orange-300 ring-1 ring-orange-500/25',
  read_only:   'bg-slate-500/10  text-slate-300  ring-1 ring-slate-500/25',
  used:        'bg-slate-500/10  text-slate-300  ring-1 ring-slate-500/25',
  succeeded:   'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  failed:      'bg-rose-500/10   text-rose-300   ring-1 ring-rose-500/25',
  configured:  'bg-sky-500/10    text-sky-300    ring-1 ring-sky-500/25',
  auth_started:'bg-amber-500/10  text-amber-300  ring-1 ring-amber-500/25',
  auth_completed:'bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/25',
  // Fallback
